        ...
        <>
            ...
            <div className='mt-10 flex gap-8 px-3 flex-col md:flex-row md:items-end'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='mt-1 text-sm'><img className='inline-block w-5' src={assets.spotify_logo} alt="album-icon" /> <span className='space-x-2'><b>Spotify</b> <span>• 1,323,154 likes</span> <b>• 50 songs,</b> about 2 hr 30 min</span></p>
                </div>
            </div>
